...
.vue-waterfall-easy(
  ...
  el-dialog(:title="currentInfo" :visible.sync="centerDialogVisible" width="84vw" height="auto" center)
    span.dialogImg
      img(:src="currentImg")
...
export default {
  ...
  methods: {
    getImg (e) {
      ...
      this.currentInfo = e.target.parentNode.nextSibling.firstChild.innerHTML;
